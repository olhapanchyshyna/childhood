                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                            Мы находимся в Киеве <br>Подольский район
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="<?php the_field('first_number'); ?>"><?php the_field('first_number'); ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="<?php the_field('second_number');?>"><?php the_field('second_number');?></a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        foreach( $posts as $post ){
                                            ...
                                            ?>
                                                <li class="glide__slide">
                                                    ...
                                                    <div class="feedslider__text"><?php the_field('reviews_descr');?></div>
                                                </li>                    
                                            <?php
                                        }
                                        wp_reset_postdata(); // сброс
