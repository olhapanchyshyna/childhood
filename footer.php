    <div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="156" title="Без названия"]');?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a target="_blank"  href="<?php the_field('instagram'); ?>" class="footer__social-item">
                            ...
                            <a target="_blank" href="<?php the_field('facebook'); ?>" class="footer__social-item">
                            ...
                            <a target="_blank" href="<?php the_field('youtube'); ?>" class="footer__social-item">
